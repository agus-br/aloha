...
<body>
    ...
    <div class="father">
        ...
        <div class="grid-descripcion">
            <div class="itemPhoto"> <div class="photo"></div> </div>
            <div class="itemInfo1"> <p class="info"> Arrendador: Felipe Lopez </p> </div>
            <div class="itemInfo2"> <p class="info"> Experiencia: 3 años </p> </div>
        </div>
        <hr>
        ...
        <div class="grid-servicios">
            ...
            <div class="itemInfo1"> <p> Wi-Fi </p> </div>

            <div class="servicios"> <span class="material-symbols-outlined">Bolt</span> </div>
            <div class="itemInfo2">  <p> Electricidad </p> </div>

            <div class="servicios"> <span class="material-symbols-outlined">directions_car</span> </div>
            <div class="itemInfo3"> <p> Cochera </p> </div>

            <div class="servicios"> <span class="material-symbols-outlined">water_drop</span> </div>
            <div class="itemInfo4"> <p> Agua </p> </div>

            <div class="servicios"> <span class="material-symbols-outlined">shower</span> </div>
            <div class="itemInfo5"> <p> Baño </p> </div>   
        </div>
        <hr>
        <div class="back">
            <div class="grid-ranking">
                <div class="puntuacion"> <p> 5.0 </p> </div>
                <div class="puntuaInfo"> <p> Favorito entre huespedes </p> </div>
                <div class="puntuaInfo2"> <p> Un alojamiento muy popular en Aloha según las calificaciones, evaluaciones y confiabilidad </p> </div>
            </div>
        </div>
        <hr>
        <div class="grid">
            <div class="contenedor">
                <div class="grid-comentarios">
                    <div class="itemPhoto"> <div class="photo2"></div> </div>
                    <div > <p class="info"> Felipe Lopez </p> </div>
                    <div> <p class="info"> Uriangato, Guanajuato </p> </div>
                </div>
                <div class="tituloComentario"> <p> Hace 1 semana </p> </div>
                <div class="comentario"> <p> La casa está muy bonita, cómoda y equipada, espacios muy amplios, áreas verdes hermosas  y la alberca muy limpia y agua caliente. El personal muy amable y al pendiente de todo. </p> </div>
            </div>
            <div class="contenedor">
                <div class="grid-comentarios">
                    <div class="itemPhoto"> <div class="photo2"></div> </div>
